...
# 2 GPUs
CUDA_VISIBLE_DEVICES=0,2 screen python -m torch.distributed.launch --nproc_per_node=2 --master_port=12354 train.py --opt_path option_R3_ChallengeDataset.yml

# 1 GPU
#CUDA_VISIBLE_DEVICES=1 screen python train.py --opt_path option_R3_ChallengeDataset.yml
