...
import edvr_tools as arch_util
from ops.dcn.deform_conv import ModulatedDeformConvPack as DCN
import numpy as np
...
class TSA_Fusion(nn.Module):
    ...
    def __init__(self, nf=64, nframes=7, center=3):
...
class EDVR(nn.Module):
    def __init__(self, nf=64, nframes=3, groups=2, front_RBs=3, back_RBs=3, center=None):
